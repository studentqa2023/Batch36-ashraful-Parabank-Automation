...
import com.pagefactory.MasterPageFectory;
...
public class StepDef {
	...
	public void enter_username_in_the_username_field(String username) {
	    mpf=new MasterPageFectory(driver);
	...
	public void validate_login_is_successful() {
	  ...
	  Assert.assertTrue(mpf.getLogoutbtn().isDisplayed(),"Login succesful" );
...
public void validate_logout_is_successful() {
	...
	else {System.out.println("Logout is faild!");
